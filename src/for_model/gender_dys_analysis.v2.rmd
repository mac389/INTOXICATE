...
```{r model_aic_calculation, include=FALSE}
model_w_gender <- glm(`Dichotomous Outcome` ~ Gender + Pulse + SBP + GCS + Age + `Respiratory Insufficiency` + Cirrhosis + `Secondary Reason for ICU Admission` + Dysrhythmia + `Exposure Category`,
