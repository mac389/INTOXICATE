...
knitr::opts_chunk$set(dev = "png",
                      ...
                      echo = FALSE,
                      cache = FALSE)
df  <-  read_excel("../data/snapshots/snapshot.04192025.xlsx", sheet = "INTOXICATE", range = cell_cols("A:AC"))
...
ggplot(roc_df, aes(x = 1 - specificity, y = sensitivity)) +
  ...
  annotate("text", x = 0.75, y = 0.25, 
           label = paste("Area under the curve =", round(auc_value, 2)), 
           hjust = 0.5, size = 4) +
...
ggsave("../output/imgs/roc_curve.png", width = 8, height = 6, dpi = 300)  
```
